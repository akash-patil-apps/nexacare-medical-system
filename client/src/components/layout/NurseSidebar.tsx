...
import { UserOutlined, DashboardOutlined, TeamOutlined, HeartOutlined, FileTextOutlined, LogoutOutlined } from '@ant-design/icons';
  ...
  return (
    <div style={{ 
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', flex: 1, alignItems: 'center' }}>
        ...
        <Button
          type="text"
          icon={<HeartOutlined style={{ fontSize: '20px', color: selectedMenuKey === 'vitals' ? '#1A8FE3' : '#6B7280' }} />}
          style={{
            width: '48px',
            height: '48px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            background: selectedMenuKey === 'vitals' ? '#E3F2FF' : 'transparent',
            borderRadius: '8px',
          }}
          onClick={() => handleMenuClick('vitals')}
        />
        
        <Button
          type="text"
          icon={<FileTextOutlined style={{ fontSize: '20px', color: selectedMenuKey === 'notes' ? '#1A8FE3' : '#6B7280' }} />}
          style={{
            width: '48px',
            height: '48px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            background: selectedMenuKey === 'notes' ? '#E3F2FF' : 'transparent',
            borderRadius: '8px',
          }}
